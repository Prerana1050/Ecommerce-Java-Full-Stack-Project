...
<body>
  ...
  <form action="/update"  method="post" enctype="multipart/form-data" >
    ...
    <label for="lname">Product Brand</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <input type="text"  name="brand" value="<%=product.getBrand()%>"><br><br>

    <label for="category">Category</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
